...
INSTALLED_APPS = [
    ...
    'rango',#added as we created an app rango
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media',#added to obtain ref to media urls
            ],
        },
    },
]
...
#redirecting to login page for restricted pages
